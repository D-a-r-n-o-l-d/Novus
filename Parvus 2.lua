...
do
    ...
    Pred:AddInput('PredCorr', { Default = tostring(Config.Prediction.GravityCorrection), Numeric = true, Finished = true, Text = 'Gravity Multiplier', Placeholder = tostring(Config.Prediction.GravityCorrection) })

    Options.PredSpeed:OnChanged(function() Config.Prediction.ProjectileSpeed = tonumber(Options.PredSpeed.Value) end)
    Options.PredGrav:OnChanged(function() Config.Prediction.Gravity = tonumber(Options.PredGrav.Value) end)
    Options.PredCorr:OnChanged(function() Config.Prediction.GravityCorrection = tonumber(Options.PredCorr.Value) end)
end
