...
do
    ...
    Hitboxes:AddSlider('HitboxSize', { Text = 'Hitbox Size', Default = Config.Hitbox.Size, Min = 0, Max = 99999, Rounding = 0 })

    Toggles.HitboxEnabled:OnChanged(function() Config.Hitbox.Enabled = Toggles.HitboxEnabled.Value end)
    Options.HitboxSize:OnChanged(function() Config.Hitbox.Size = Options.HitboxSize.Value end)
end
...
do
    ...
    AimDep:AddSlider('AimbotSens', { Text = 'Sensitivity', Default = Config.Aimbot.Sensitivity, Min = 0, Max = 99999, Rounding = 0 })
    AimDep:AddSlider('AimbotFOV', { Text = 'FOV Radius', Default = Config.Aimbot.FOVRadius, Min = 0, Max = 99999, Rounding = 0 })
    AimDep:AddSlider('AimbotDist', { Text = 'Distance Limit', Default = Config.Aimbot.DistanceLimit, Min = 0, Max = 99999, Rounding = 0 })
    ...
    local function wireAim()
        ...
        c.Sensitivity = Options.AimbotSens.Value
        c.FOVRadius = Options.AimbotFOV.Value
        c.DistanceLimit = Options.AimbotDist.Value
...
do
    ...
    TrigDep:AddSlider('TriggerDelay', { Text = 'Delay', Default = Config.Trigger.Delay * 1000, Min = 0, Max = 99999, Rounding = 0 })
    TrigDep:AddSlider('TriggerFOV', { Text = 'FOV Radius', Default = Config.Trigger.FOVRadius, Min = 0, Max = 99999, Rounding = 0 })
    TrigDep:AddSlider('TriggerDist', { Text = 'Distance Limit', Default = Config.Trigger.DistanceLimit, Min = 0, Max = 99999, Rounding = 0 })
    ...
    local function wireTrig()
        ...
        c.Delay = Options.TriggerDelay.Value / 1000
        c.FOVRadius = Options.TriggerFOV.Value
        c.DistanceLimit = Options.TriggerDist.Value
...
do
    ...
    Pred:AddSlider('PredSpeed', { Text = 'Projectile Speed', Default = Config.Prediction.ProjectileSpeed, Min = 0, Max = 99999, Rounding = 0 })
    Pred:AddSlider('PredGrav', { Text = 'Gravity', Default = Config.Prediction.Gravity, Min = 0, Max = 99999, Rounding = 0 })
    Pred:AddSlider('PredCorr', { Text = 'Gravity Multiplier', Default = Config.Prediction.GravityCorrection, Min = 0, Max = 99999, Rounding = 0 })

    Options.PredSpeed:OnChanged(function() Config.Prediction.ProjectileSpeed = Options.PredSpeed.Value end)
    Options.PredGrav:OnChanged(function() Config.Prediction.Gravity = Options.PredGrav.Value end)
    Options.PredCorr:OnChanged(function() Config.Prediction.GravityCorrection = Options.PredCorr.Value end)
end
...
do
    ...
    Move:AddSlider('WalkSpeed', { Text = 'WalkSpeed', Default = Config.Movement.WalkSpeed, Min = 0, Max = 99999, Rounding = 0 })
    Move:AddSlider('JumpPower', { Text = 'JumpPower', Default = Config.Movement.JumpPower, Min = 0, Max = 99999, Rounding = 0 })
    Move:AddToggle('ClickTP', { Text = 'Click Teleport', Default = Config.Movement.ClickTP })

    Options.WalkSpeed:OnChanged(function()
        Config.Movement.WalkSpeed = Options.WalkSpeed.Value
        applyWalkSpeed()
    end)
    Options.JumpPower:OnChanged(function()
        Config.Movement.JumpPower = Options.JumpPower.Value
        applyJumpPower()
    end)
...
do
    ...
    FOV:AddSlider('FOVThickness', { Text = 'Thickness', Default = Config.AimVisuals.Thickness, Min = 0, Max = 99999, Rounding = 0 })
    FOV:AddSlider('FOVSides', { Text = 'Sides', Default = Config.AimVisuals.Sides, Min = 0, Max = 99999, Rounding = 0 })
    ...
    local function wireFOV()
        ...
        Config.AimVisuals.Thickness = Options.FOVThickness.Value
        Config.AimVisuals.Sides = Options.FOVSides.Value
...
do
    ...
    ArrDep:AddSlider('ArrowsSize', { Text = 'Size', Default = ArrowConfig.Size, Min = 0, Max = 99999, Rounding = 0 })
    ArrDep:AddSlider('ArrowsRadius', { Text = 'Radius', Default = ArrowConfig.Radius, Min = 0, Max = 99999, Rounding = 0 })
    ArrDep:AddSlider('ArrowsThickness', { Text = 'Thickness', Default = ArrowConfig.Thickness, Min = 0, Max = 99999, Rounding = 0 })
    ...
    local function wireArrow()
        ...
        ArrowConfig.Size = Options.ArrowsSize.Value
        ArrowConfig.Radius = Options.ArrowsRadius.Value
        ArrowConfig.Thickness = Options.ArrowsThickness.Value
...
do
    ...
    RadDep:AddSlider('RadarRadius', { Text = 'Radar Size', Default = RadarInfo.Radius, Min = 0, Max = 99999, Rounding = 0 })
    RadDep:AddSlider('RadarScale', { Text = 'Scale', Default = RadarInfo.Scale, Min = 0, Max = 99999, Rounding = 0 })
    RadDep:AddSlider('RadarMaxDist', { Text = 'Max Distance', Default = RadarInfo.MaxDistance, Min = 0, Max = 99999, Rounding = 0 })
    ...
    local function wireRadar()
        ...
        RadarInfo.Radius = Options.RadarRadius.Value
        RadarInfo.Scale = Options.RadarScale.Value
        RadarInfo.MaxDistance = Options.RadarMaxDist.Value
    end
